...
alias ansibe_decrypt='ansible-vault decrypt --vault-id kinglabs@~/ansible-kinglabs/kinglabs.vault'
alias ansibe_encrypt='ansible-vault encrypt --vault-id kinglabs@~/ansible-kinglabs/kinglabs.vault'
